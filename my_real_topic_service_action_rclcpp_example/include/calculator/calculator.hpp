...
#include "my_real_msg_srv_action_interface_example/msg/arithmetic_argument.hpp"
#include "my_real_msg_srv_action_interface_example/srv/arithmetic_operator.hpp"
#include "my_real_msg_srv_action_interface_example/action/arithmetic_checker.hpp"


class Calculator : public rclcpp::Node
{
public:
  using ArithmeticArgument = my_real_msg_srv_action_interface_example::msg::ArithmeticArgument;
  using ArithmeticOperator = my_real_msg_srv_action_interface_example::srv::ArithmeticOperator;
  using ArithmeticChecker = my_real_msg_srv_action_interface_example::action::ArithmeticChecker;
